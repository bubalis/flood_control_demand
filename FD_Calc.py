...
#from utils import load_if_path, max_rast_value_in_shp, count_points_in, sum_pts_weights, numpy_replace
...
class floodDemandCalculator():
    ...
    def __init__(self, wkdir = None):
        '''
        Initialize the Flood Demand Calculator, working in wkdir

        Parameters
        ----------
        wkdir : working directory, optional
